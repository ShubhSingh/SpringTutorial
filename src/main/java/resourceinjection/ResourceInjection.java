...
public class ResourceInjection {
	...
	/**
	 * In case u wana inject resources that are static, u can directly inject
	 * that. See the resourceContext.xml. We have just set the path and using the javabeans propertyeditor, spring will
