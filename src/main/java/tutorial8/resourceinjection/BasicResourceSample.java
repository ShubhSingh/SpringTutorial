...
public class BasicResourceSample {
	 ...
	 * resource. The Resource object returned by the following classes is a simple and handy object containing all the info of the resource 
	...
	public static void main(String[] args) throws Exception {
		...
		resource = new ClassPathResource("tutorial8/resourceinjection/sample.txt");
		try {
			inputStream = resource.getInputStream();
